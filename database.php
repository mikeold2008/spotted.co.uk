...
class DB
{
	...
	/*** mysql username ***/
	//private $username = 'root'; // Charley's development server username
	private $username = 'spotted_mysql'; // Put your MySQL User name here

	/*** mysql password ***/
	//private $password = ''; // Charley's development server password
	private $password = 'eUEuddrz'; // Production server password

	/*** mysql password ***/
	private $dbName = 'spotted_mysql'; // Put Your MySQL Database name here
